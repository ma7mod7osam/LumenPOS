...
*Applies to LumenPOS v0.51.1. This document is updated with every feature change.*
...
> to enrol a new customer in a loyalty program), so assigning it is enough to run
> a till, adding customers included.
